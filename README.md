...
- [ ] [Set up project integrations](https://kbit-repo.net/gitlab/shimatani/pc_power_log/-/settings/integrations)
...
>>>>>>> b5fea20 (Add: READMEとメインスクリプトを追加 (Add README and main script))
